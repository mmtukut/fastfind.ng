          ...
          <div className="flex items-center gap-6">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div className="hidden sm:block">
                <p className="font-bold text-lg text-gray-900">FastFind360</p>
                <p className="text-xs text-gray-500 -mt-1">Property Intelligence</p>
              </div>
            </Link>
            
            <div className="hidden md:flex items-center bg-gray-100 rounded-lg p-1">
              <Button size="sm" variant="ghost" className="bg-white shadow rounded-md">
          ...
          <div className="hidden lg:flex flex-1 max-w-md mx-6">
            <div className="relative w-full">
              ...
              <input 
                ...
                className="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="hidden xl:flex items-center gap-4">
              <div>
                ...
                <p className="font-bold text-gray-900">49,997</p>
              </div>
              <Separator orientation="vertical" className="h-8" />
              <div>
                <p className="text-xs text-gray-500">Revenue Potential</p>
                <p className="font-bold text-gray-900">₦2.6B</p>
              </div>
            </div>
            ...
            >
              <Badge className={`mr-2 transition-colors ${isAdminView ? 'bg-white/20 text-white' : 'bg-primary/10 text-primary-600'}`}>
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            ...
            <Button variant="outline" className="w-full justify-center"><Download className="w-4 h-4 mr-2" /> Export Data</Button>
          </motion.div>
        )}
      </AnimatePresence>
    </header>
